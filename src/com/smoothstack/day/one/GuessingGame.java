...
public class GuessingGame {
	...
	public static void main(String[] args) {
		...
		while (guesses < 5) {
			...
			while(guess == null) {
				System.out.print("[Guess " + (guesses + 1) + " of 5] What do you think the number is? (between 1-100): ");
			...
			if (guess >= bottomRange && guess <= topRange) {
				System.out.println("Good job! The number was " + randomNumber + " and you guessed it in " + (guesses + 1) + " tries.");
				inputScanner.close();
				System.exit(0);
			} else if(guesses < 4){
